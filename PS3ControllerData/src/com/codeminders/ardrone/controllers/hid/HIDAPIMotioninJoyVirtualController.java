...
import com.codeminders.ardrone.controllers.decoders.MotioninJoyVirtualStateDecoder;
...
public class HIDAPIMotioninJoyVirtualController extends HIDAPIController {
    ...
    // Modified 09.09.15 (ControllerStateDecoder was not instanciated, object was null)
    private static ControllerStateDecoder decoder = new MotioninJoyVirtualStateDecoder();
    ...
    public boolean isValid(ControllerData data) throws IOException {
        ...
        {
            System.out.println("Buffer length = " + data.getActualBufferDataLength());
